...
export default function MMAFullFightGlovesPage() {
  ...
  const handleQuoteSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    formData.append("subject", "New Private Label Quote Request - MMA Full Fight Gloves");
          ...
          <div className="flex-1 max-w-full lg:max-w-[616px] mx-auto lg:mx-0">
            ...
            <form onSubmit={handleQuoteSubmit} className="flex flex-col gap-4">
              ...
              <div className="border border-[#C9C9C9] rounded px-3 py-3 flex flex-col gap-0">
                <label htmlFor="mma-name" className="text-[11px] leading-[14px]" style={{ fontFamily: "'FFF Acid Grotesk', sans-serif", fontWeight: 400, color: "#707070" }}>Full Name*</label>
                <input 
                  id="mma-name"
                  type="text" 
                  name="name"
              ...
              <div className="border border-[#C9C9C9] rounded px-3 py-3 flex flex-col gap-0">
                <label htmlFor="mma-email" className="text-[11px] leading-[14px]" style={{ fontFamily: "'FFF Acid Grotesk', sans-serif", fontWeight: 400, color: "#707070" }}>Business Email*</label>
                <input 
                  id="mma-email"
                  type="email" 
                  name="email"
              ...
              <div className="border border-[#C9C9C9] rounded px-3 py-3 flex flex-col gap-0">
                <label htmlFor="mma-phone" className="text-[11px] leading-[14px]" style={{ fontFamily: "'FFF Acid Grotesk', sans-serif", fontWeight: 400, color: "#707070" }}>Phone Number (Optional)</label>
                <input 
                  id="mma-phone"
                  type="tel" 
                  name="phone"
              ...
              <div className="flex flex-col lg:grid lg:grid-cols-2 gap-4 lg:gap-3">
                ...
                <div className="border border-[#C9C9C9] rounded px-3 py-3 flex flex-col gap-0 bg-[#F9F9F9]">
                  <label htmlFor="mma-product" className="text-[11px] leading-[14px]" style={{ fontFamily: "'FFF Acid Grotesk', sans-serif", fontWeight: 400, color: "#707070" }}>Product Name*</label>
                  <input 
                    id="mma-product"
                    type="text"
                    name="productName"
                ...
                <div className="border border-[#C9C9C9] rounded px-3 py-3 flex flex-col gap-0 relative">
                  <label htmlFor="mma-quantity" className="text-[11px] leading-[14px]" style={{ fontFamily: "'FFF Acid Grotesk', sans-serif", fontWeight: 400, color: "#707070" }}>Estimated Order Quantity*</label>
                  <input 
                    id="mma-quantity"
                    type="text" 
                    name="quantity"
              ...
              <div className="border border-[#C9C9C9] rounded px-3 py-3 flex flex-col gap-0 mb-4">
                <label htmlFor="mma-message" className="text-[11px] leading-[14px]" style={{ fontFamily: "'FFF Acid Grotesk', sans-serif", fontWeight: 400, color: "#707070" }}>Project Details*</label>
                <textarea 
                  id="mma-message"
                  name="message"
                  required
              ...
              {/* Buttons maintain exact MMA Page styling */}
