...
// ─── Product Data ──────────────────────────────────────────────────────────
const allProducts = [
  { name: "Private Label Boxing Gloves", category: "Boxing Equipment", cta: "View Product +", href: "/details", swatches: ["#B91C1C", "#0D0D0D"], image: "/Products/01 Private Label Boxing Gloves.png" },
  { name: "BJJ Gis and Jiu-Jitsu Uniforms", category: "Martial Arts Uniforms", cta: "View Product +", href: "/jitsu", swatches: ["#0D0D0D", "#E5E5E5"], image: "/Products/02 BJJ Gis and Jiu-Jitsu Uniforms.png" },
  { name: "MMA Fight Gloves", category: "MMA Equipment", cta: "View Product +", href: "/mmagloves", swatches: ["#B91C1C", "#0D0D0D"], image: "/Products/03 MMA Fight Gloves.png" },
  { name: "Professional MMA Training Gloves", category: "MMA Equipment", cta: "View Product +", href: "/ultimategloves", swatches: ["#B91C1C", "#0D0D0D"], image: "/Products/MMATrainingGloves.png" },
  { name: "Boxing Focus Mitts and Training Pads", category: "Training Equipment", cta: "View Product +", href: "/trainingpad", swatches: ["#B91C1C", "#0D0D0D"], image: "/Products/05 Boxing Mitts and Training Pads.png" },
  { name: "Boxing Sparring Gloves", category: "Boxing Equipment", cta: "View Product +", href: "/sparinggloves", swatches: ["#B91C1C", "#0D0D0D"], image: "/Products/06 Boxing Sparring Gloves.png" },
  { name: "Custom Boxing Headguards", category: "Protective Equipment", cta: "View Product +", href: "/Boxingguard", swatches: ["#B91C1C", "#0D0D0D"], image: "/Products/07 Custom Boxing Headguards.png" },
  { name: "Private Label Karate Uniforms", category: "Martial Arts Uniforms", cta: "View Product +", href: "/karatesuit", swatches: ["#E5E5E5", "#0D0D0D"], image: "/Products/karateuniform.png" },
];
...
const customizationOptions = [
  ...
  { title: "Custom Materials and Colors", desc: "Choose genuine leather, microfiber leather, premium PU, cotton canvas, neoprene, EVA foam, custom fabrics, and branded color combinations.", image: "/Page 2/Images/03.png" },
  { title: "Labels, Tags and Packaging", desc: "Create woven labels, hang tags, barcode stickers, instruction cards, poly bags, retail boxes, and branded shipping cartons.", image: "/Page 2/Images/04.png" },
  { title: "Sizing and Product Specifications", desc: "Customize dimensions, weight, fit, padding density, stitching, closures, and performance features before production.", image: "/Page 2/Images/05.png" },
];
  ...
  return (
    <div className="w-full bg-white text-black font-sans flex flex-col items-center overflow-x-hidden">
        ...
        <div className="relative w-full max-w-[2560px] h-[540px] md:h-[624px]">
          ...
          <div className="relative z-10 flex items-center h-full px-6 md:px-10 mt-4 md:mt-0">
            <div className="max-w-[640px] flex flex-col gap-4 md:gap-6">
              <h1 className="uppercase text-[36px] leading-[40px] md:text-[56px] md:leading-[105%]" style={{ fontFamily: "'FFF Acid Grotesk', sans-serif", fontWeight: 500, letterSpacing: "-2px", color: "#FFFFFF" }}>
      ...
      <section className="w-full bg-white py-16 md:py-24 flex justify-center">
        <div className="w-full max-w-[2560px] px-6 md:px-10 flex flex-col lg:flex-row gap-8 md:gap-12 lg:gap-20">
          <div className="lg:w-1/2">
            <h2>
              <span className="block text-[28px] leading-[32px] md:text-[37px] md:leading-[46px]" style={{ fontFamily: "'FFF Acid Grotesk', sans-serif", fontWeight: 700, letterSpacing: "-1.52px", color: "#757575" }}>
                Why Brands Choose
              </span>
              <span className="block text-[28px] leading-[32px] md:text-[37px] md:leading-[46px]" style={{ fontFamily: "'FFF Acid Grotesk', sans-serif", fontWeight: 700, letterSpacing: "-1.52px", color: "#000000" }}>
      ...
      <section className="w-full bg-white py-16 md:py-24 flex justify-center">
        <div className="w-full max-w-[2560px] px-6 md:px-10">
          <div className="mb-10 md:mb-16">
            <h2 className="mb-4 md:mb-6 text-[28px] leading-[32px] md:text-[37px] md:leading-[46px]" style={{ fontFamily: "'FFF Acid Grotesk', sans-serif", fontWeight: 700, letterSpacing: "0px", color: "#0D0D0D" }}>
              Private Label Customization Options
            </h2>
            <p className="max-w-[800px] text-[14px] leading-[22px] md:text-[16px] md:leading-[24px]" style={{ fontFamily: "'FFF Acid Grotesk', sans-serif", fontWeight: 400, letterSpacing: "0px", color: "#434343" }}>
      ...
      <section className="w-full bg-white py-16 md:py-24 border-t border-gray-200 flex justify-center">
        <div className="w-full max-w-[2560px] px-6 md:px-10">
          <h2 className="mb-10 md:mb-16 text-[28px] leading-[34px] md:text-[37px] md:leading-[46px]" style={{ fontFamily: "'FFF Acid Grotesk', sans-serif", fontWeight: 500, letterSpacing: "-1.5px", color: "#000000" }}>
            Why Brands Manufacture With<br className="hidden md:block" /><span className="md:hidden"> </span>Sarlam Athletics
          </h2>
      ...
      <footer className="w-full bg-white flex flex-col items-center">
        ...
        <div className="w-full max-w-[2560px] px-6 md:px-10 py-12 md:py-16 flex flex-col lg:flex-row justify-between gap-10 md:gap-12">
          <div className="lg:w-1/2">
            <h3 className="mb-4 text-[32px] leading-[38px] md:text-[47px] md:leading-[58px]" style={{ fontFamily: "'FFF Acid Grotesk', sans-serif", fontWeight: 500, letterSpacing: "-1.9px", color: "#000000" }}>
              Start Your Private Label<br className="hidden md:block" /><span className="md:hidden"> </span>Manufacturing Project
            </h3>
            <a href="mailto:hello@sarlamathletics.com" className="transition break-all text-[22px] leading-[30px] md:text-[47px] md:leading-[58px] hover:text-black" style={{ fontFamily: "'FFF Acid Grotesk', sans-serif", fontWeight: 500, letterSpacing: "-1px", color: "#A5A5A5" }}>
        ...
        <div className="w-full border-t border-gray-200" />
        <div className="w-full max-w-[2560px] px-6 md:px-10 py-8 md:py-10 flex flex-col md:flex-row items-start md:items-end justify-between gap-4 md:gap-0">
          <p className="uppercase text-[56px] leading-[85%] md:text-[101px] md:leading-[85%]" style={{ fontFamily: "'FFF Acid Grotesk', sans-serif", fontWeight: 700, fontStyle: "italic", letterSpacing: "-3%", color: "#000000" }}>
        ...
        <div className="w-full bg-[#0D0D0D] py-4">
          <div className="w-full max-w-[2560px] mx-auto px-6 md:px-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-2 md:gap-0">
