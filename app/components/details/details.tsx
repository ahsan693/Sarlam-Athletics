    ...
    <div className="min-h-screen bg-white font-['FFF_Acid_Grotesk',sans-serif]">
      ...
      <section className="relative h-[320px] md:h-[480px] overflow-hidden flex justify-center">
        <div className="absolute inset-0 bg-black max-w-[2560px] mx-auto w-full">
          <img src="/Page 3/Container.png" alt="Boxing Gloves" className="w-full h-full object-cover opacity-60" />
        </div>
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center md:justify-center lg:justify-between gap-6 lg:gap-10">
            {features.map((feature, i) => (
              <div key={i} className="flex items-center gap-3">
                ...
                <p className="text-[15px] leading-[21px] tracking-[0.45px] font-medium text-[#0D0D0D] text-left md:text-[15px] md:leading-snug md:tracking-normal max-w-[250px]">{feature.text}</p>
              </div>
            ))}
          </div>
        </div>
            ...
            {relatedProducts.map((product, i) => (
              <div key={i} data-related-card className="border border-[#C9C9C9] rounded bg-white flex flex-col md:w-[360px] md:snap-start md:shrink-0 md:rounded-none group">
                ...
                <div className="px-2 pb-2 flex flex-col gap-2 md:px-5 md:py-4 md:flex-row md:items-center md:justify-between md:gap-0 mt-auto border-t border-transparent md:border-gray-200">
                  ...
                  <RollingButton
                    href={product.href}
                    className="text-[10px] leading-[12px] font-bold text-[#0D0D0D] underline md:no-underline md:border md:border-[#0D0D0D] md:px-3 md:py-1.5 md:uppercase md:text-[10px] md:font-medium"
                  >
                    {product.cta}
                  </RollingButton>
                </div>
      ...
      <section className="px-6 md:px-20 py-16 md:py-24 flex justify-center w-full">
        <div className="w-full max-w-[2560px]">
      ...
      <section className="w-full bg-white py-16 md:py-24 flex justify-center">
        <div className="w-full max-w-[2560px] px-6 md:px-10">
          ...
          <div className="relative">
            <div ref={customizationScrollerRef} className="flex gap-4 md:gap-6 overflow-x-auto scroll-smooth snap-x snap-mandatory pb-4 border-t border-gray-200 hide-scrollbar pt-6 md:pt-8">
              {customizationOptions.map((option, i) => (
                <div key={i} data-card className="snap-start shrink-0 w-[280px] sm:w-[320px] lg:w-[calc(25%-18px)] bg-white border border-gray-200 md:border-t-0 md:border-l-0 md:border-b md:border-r overflow-hidden flex flex-col">
                  ...
                  <div className="p-6 md:p-8 flex-1 flex flex-col">
                    <h3 className="mb-3 md:mb-4 text-[18px] leading-[22px] md:text-[22px] md:leading-[26px]" style={{ fontFamily: "'FFF Acid Grotesk', sans-serif", fontWeight: 700, letterSpacing: "0px", color: "#0D0D0D" }}>{option.title}</h3>
                    <p className="text-[14px] leading-[22px]" style={{ fontFamily: "'FFF Acid Grotesk', sans-serif", fontWeight: 400, letterSpacing: "0px", color: "#434343" }}>{option.desc}</p>
                  </div>
                </div>
              ))}
            </div>
