...
// ─── Data ───
const finishOptions = ["STANDARD", "MATTE", "GLOSSY"];
const fitOptions = ["MEN", "WOMEN", "UNISEX"];
...
const sizeOptionsWeight = ["10OZ", "12OZ", "14OZ", "16OZ"];
...
export default function BoxingSparringGlovesPage() {
...
/>
          ...
          <div className="flex-1 max-w-full lg:max-w-[616px]">
            ...
            <nav className="flex items-center flex-wrap gap-2 text-[10px] md:text-xs text-[#6A7282] mb-6 md:mb-8 font-medium uppercase tracking-wide">
              ...
              <span>/</span>
              <a href="/products/boxing-gloves" className="hover:underline text-[#6A7282]">Boxing Gloves</a>
              <span>/</span>
              <span className="text-[#0D0D0D]">Boxing Practice / Sparring Gloves</span>
            </nav>
            ...
            <div className="mb-8 md:mb-6">
              <p className="text-[14px] leading-[22px] md:text-base text-[#666666] md:leading-relaxed font-normal">
                Sarlam Athletics manufactures custom boxing gloves for combat sports brands, martial arts academies, gyms, retailers, and distributors. We support custom materials, sizing, colorways, padding, wrist closures, labels, packaging, and branding details for wholesale production.
              </p>
