...
/>
  ...
  <img
  src="/Products/05 Boxing Mitts and Training Pads.png"
  alt="Training Pads"
...
/>
          ...
          <div className="flex-1 max-w-full lg:max-w-[616px]">
            ...
            <nav className="flex items-center flex-wrap gap-2 text-[10px] md:text-xs text-[#6A7282] mb-6 md:mb-8 font-medium uppercase tracking-wide">
              ...
              <span>/</span>
              <a href="/products" className="hover:underline">Boxing Equipment</a>
              <span>/</span>
            ...
            {/* Size/Style Options - Grouped layout */}
            <div className="mb-6 md:mb-8">
