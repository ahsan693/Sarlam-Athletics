...
export default function TrainingPadsPage() {
  ...
  const handleQuoteSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    formData.append("subject", "New Private Label Quote Request - Training Pads");
          ...
          <div className="flex-1 max-w-full lg:max-w-[616px] mx-auto lg:mx-0">
            ...
            <form onSubmit={handleQuoteSubmit} className="flex flex-col gap-4">
              ...
              <div className="border border-[#C9C9C9] rounded px-3 py-3 flex flex-col gap-0">
                <label htmlFor="trainingpads-name" className="text-[11px] leading-[14px]" style={{ fontFamily: "'FFF Acid Grotesk', sans-serif", fontWeight: 400, color: "#707070" }}>Full Name*</label>
                <input 
                  id="trainingpads-name"
                  type="text" 
                  name="name"
                  required
              ...
              <div className="border border-[#C9C9C9] rounded px-3 py-3 flex flex-col gap-0">
                <label htmlFor="trainingpads-email" className="text-[11px] leading-[14px]" style={{ fontFamily: "'FFF Acid Grotesk', sans-serif", fontWeight: 400, color: "#707070" }}>Business Email*</label>
                <input 
                  id="trainingpads-email"
                  type="email" 
                  name="email"
                  required
              ...
              <div className="border border-[#C9C9C9] rounded px-3 py-3 flex flex-col gap-0">
                <label htmlFor="trainingpads-phone" className="text-[11px] leading-[14px]" style={{ fontFamily: "'FFF Acid Grotesk', sans-serif", fontWeight: 400, color: "#707070" }}>Phone Number (Optional)</label>
                <input 
                  id="trainingpads-phone"
                  type="tel" 
                  name="phone"
              ...
              <div className="flex flex-col lg:grid lg:grid-cols-2 gap-4 lg:gap-3">
                ...
                <div className="border border-[#C9C9C9] rounded px-3 py-3 flex flex-col gap-0 bg-[#F9F9F9]">
                  <label htmlFor="trainingpads-product" className="text-[11px] leading-[14px]" style={{ fontFamily: "'FFF Acid Grotesk', sans-serif", fontWeight: 400, color: "#707070" }}>Product Name*</label>
                  <input 
                    id="trainingpads-product"
                    type="text"
                    name="productName"
                    aria-label="Product name"
                    value="Training Pads (Focus Mitts & Thai Pads)"
                    readOnly
                ...
                <div className="border border-[#C9C9C9] rounded px-3 py-3 flex flex-col gap-0 relative">
                  <label htmlFor="trainingpads-quantity" className="text-[11px] leading-[14px]" style={{ fontFamily: "'FFF Acid Grotesk', sans-serif", fontWeight: 400, color: "#707070" }}>Estimated Order Quantity*</label>
                  <input 
                    id="trainingpads-quantity"
                    type="text" 
                    name="quantity"
                    required
              ...
              <div className="border border-[#C9C9C9] rounded px-3 py-3 flex flex-col gap-0 mb-4">
                <label htmlFor="trainingpads-message" className="text-[11px] leading-[14px]" style={{ fontFamily: "'FFF Acid Grotesk', sans-serif", fontWeight: 400, color: "#707070" }}>Project Details*</label>
                <textarea 
                  id="trainingpads-message"
                  name="message"
                  required
              ...
              {/* Buttons matching the Training Pads Page Layout */}
