...
const MenuIcon = () => <svg width="20" height="14" viewBox="0 0 20 14" fill="none"><line y1="1" x2="20" y2="1" stroke="currentColor" strokeWidth="2" /><line y1="7" x2="20" y2="7" stroke="currentColor" strokeWidth="2" /><line y1="13" x2="20" y2="13" stroke="currentColor" strokeWidth="2" /></svg>;
const SearchIcon = () => <svg width="20" height="20" viewBox="0 0 20 20" fill="none"><circle cx="9" cy="9" r="7" stroke="currentColor" strokeWidth="2" /><line x1="14" y1="14" x2="19" y2="19" stroke="currentColor" strokeWidth="2" /></svg>;
...
const materialOptions = ["100% COTTON CANVAS", "POLY-COTTON BLEND", "LIGHTWEIGHT (8OZ)", "MEDIUMWEIGHT (10OZ)", "HEAVYWEIGHT (14OZ)"];
const brandingOptions = ["DIRECT EMBROIDERY (CHEST/NECK)", "SCREEN PRINT (BACK)", "WOVEN LABELS"];
      ...
      <section className="px-5 md:px-16 py-16 md:py-24">
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-32 max-w-[2560px] mx-auto lg:justify-center">
          ...
          <div className="w-full lg:w-[616px] shrink-0">
            ...
            <img src="/Products/02 BJJ Gis and Jiu-Jitsu Uniforms.png" alt="Jiu Jitsu Suit Gi" className="w-[100%] h-[100%] md:w-[600px] md:h-[600px] object-cover md:object-contain mix-blend-multiply" />
            </div>
          </div>
          ...
          <div className="flex-1 max-w-full lg:max-w-[616px] mx-auto lg:mx-0">
            ...
            <nav className="flex items-center flex-wrap gap-2 font-['PP_Mori',sans-serif] text-[12px] leading-[16px] tracking-[0px] text-[#6A7282] font-normal md:font-['FFF_Acid_Grotesk',sans-serif] md:text-xs md:font-medium mb-6 md:mb-8 text-left uppercase md:tracking-wide">
              ...
              <a href="/products" className="hover:underline text-[#6A7282]">MARTIAL ARTS UNIFORM MANUFACTURING OPTIONS</a><span>/</span>
            ...
            <div className="mb-6 md:mb-8">
              ...
              <div className="space-y-4">
                {Object.entries(sizeRanges).map(([groupLabel, sizes]) => (
                  <div key={groupLabel}>
                    <span className="block text-[12px] leading-[16px] tracking-[0px] font-normal text-[#666666] mb-2 uppercase text-left md:font-medium md:text-xs">{groupLabel}</span>
