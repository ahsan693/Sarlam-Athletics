        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-32 max-w-[2560px] mx-auto lg:justify-center">
          ...
          <div className="w-full lg:w-[616px] shrink-0">
            <div className="bg-[#F9F9F9] rounded-none p-4 md:p-2 aspect-[4/5] md:aspect-square flex items-center justify-center lg:sticky lg:top-24 max-w-[800px] mx-auto">
              <img src="/Products/karateuniform.png" alt="Karate Suit Gi" className="w-[100%] h-[100%] md:w-[600px] md:h-[600px] object-cover md:object-contain mix-blend-multiply" />
            </div>
          </div>
          ...
          <div className="flex-1 max-w-full lg:max-w-[616px] mx-auto lg:mx-0">
            <nav className="flex items-center flex-wrap gap-2 text-[10px] md:text-xs text-[#6A7282] mb-6 md:mb-8 font-medium uppercase tracking-wide">
              ...
              <a href="/products" className="hover:underline">Karate Uniforms</a><span>/</span>
              <span className="text-[#0D0D0D]">Karate Suit (Gi)</span>
            </nav>
            ...
            <div className="mb-6">
              ...
              <p className="text-[15px] leading-[22px] md:text-xl text-[#0D0D0D] mt-3 md:mt-4 md:leading-relaxed font-normal">
                Custom Karate uniform manufacturing for dojos, academies, retailers, and martial arts wear brands.
              </p>
            </div>
            ...
            <div className="mb-6 md:mb-8">
              <div className="flex items-center justify-between mb-3">
                ...
                <button className="text-[11px] md:text-xs text-[#666666] hover:underline font-medium">Size Guide</button>
              </div>
              <div className="space-y-4">
                {Object.entries(sizeRanges).map(([groupLabel, sizes]) => (
                  <div key={groupLabel}>
                    <span className="block text-[11px] md:text-xs font-medium text-[#666666] mb-2 uppercase">{groupLabel}</span>
            ...
            <div className="space-y-3 md:space-y-4 mb-4 mt-8 md:mt-12">
              <RollingButton className="w-full bg-[#0D0D0D] text-white text-[13px] md:text-sm font-bold py-4 md:py-[18px] uppercase tracking-wide rounded-[4px]">
                Request Manufacturing Quote
              </RollingButton>
              <RollingButton className="w-full border border-[#0D0D0D] text-[#0D0D0D] text-[13px] md:text-sm font-bold py-4 md:py-[18px] uppercase tracking-wide rounded-[4px]">
                Ask About Samples
              </RollingButton>
            </div>
